...
[Group project for HVL DAT250 course](https://github.com/selabhvl/dat250public/tree/master/projectdescription)
Image on [dockerhub](https://hub.docker.com/repository/docker/nikolaihg/feedapp)
## Tech stack
- Backend:
    - Spring Boot
